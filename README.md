# Ovedly — workforce, payroll and business-finance platform

I built **Ovedly** as a full-stack workforce management system for businesses that need one reliable place to manage employees, work hours, payroll, salary advances, payments, income, expenses and financial reporting.
...
I designed Ovedly around those problems. Each workflow shares the same employee, work-entry, payroll and finance data, while permissions and calculations remain centralised on the server.

## Product walkthrough

### 1. Secure sign-in and role-aware access

![Ovedly login page](screenshots/00-login.png)
...
**Typical use case:** a business owner opens Ovedly at the end of the week and immediately sees how much salary has accumulated, what has already been paid and what is still outstanding.
