...
![Secure sign-in](screenshots/00-login.png)
...
![Employee profile](screenshots/09-admin-employee-profile.png)
...
![Work hours](screenshots/03-admin-hours.png)
...
![Employee advances](screenshots/05-admin-advances.png)
...
![Activity log](screenshots/07-admin-audit.png)

Use the audit log to trace important account, payroll, export, lock, and reversal actions.

### Settings

![Settings](screenshots/08-admin-settings.png)
...
![My work hours](screenshots/11-employee-hours.png)
...
![My payroll](screenshots/12-employee-payroll.png)
